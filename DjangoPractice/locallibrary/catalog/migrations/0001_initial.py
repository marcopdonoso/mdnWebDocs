    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 Caracteres <a href="https://www.isbn-international.org/content/wht-isbn">ISBN number</a>', max_length=13, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Ingrese el nombre del genero (p. ej. Ciencia Ficción, Poesía Francesa, etc.)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
